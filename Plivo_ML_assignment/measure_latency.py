...
def main():
    ...
    ap.add_argument("--misspell", default="data/misspell_map.json")
    ...
    pp = PostProcessor(args.names, misspell_map_path=args.misspell, onnx_model_path=args.onnx, device=args.device, max_length=64)
